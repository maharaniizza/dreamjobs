...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>DreamJobs - Register</title>
      ...
      <div class="card-body p-0">
        ...
        <div class="row">
         <div class="col-lg-5 d-none d-lg-block">
              <img src="gambar.png" alt="SIMPROVA" width="500" align="middle">
          </div>
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <input type="hidden" name="roleid" value="1">
                ...
                <h1 class="h4 text-red-900 mb-4" style="color: red"><?php echo $_SESSION['errreg']?></h1>
                <?php }?>
