                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <div class="ibox-content">
                                    <form method="POST" class="form-horizontal col-12" action="controller/UUpdateProfile.php">
                                      <input type="hidden" name="action" value="SaveProfile">
                                        ...
                                        <div class="form-group mb-sm-3 row">
                                            ...
                                            <div class="col-8">
                                               <label class="col-4 control-label"><?php echo $res['FirstName']." ".$res['LastName'] ?></label>
                                            </div>
                                        </div>
                                        <div class="form-group mb-sm-3 row">
                                        ...
                                        <div class="form-group mb-sm-3 row">
                                            ...
                                            <div class="col-8">
                                                <textarea name="address" class="form-control form-control-user"><?= $res['ApplicantAddress'] ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group mb-sm-3 row">
                                            <label class="col-4 control-label">Phone Number</label>
                                            <div class="col-8">
                                                <input type="text" name="phoneNumber" class="form-control form-control-user" value=<?= $res['ApplicantPhone'] ?>>
                                            </div>
                                        </div>
                                        <div class="form-group mb-sm-3 row">
                                            <label class="col-4 control-label">Email</label>
                                            <div class="col-8">
                                                <label class="col-4 control-label"><?= $res['UserEmail'] ?></label>
                                            </div>
                                        </div>
                                        <div class="form-group mb-sm-3 row">
                                            <label class="col-4 control-label">Identity No (KTP)</label>
                                            <div class="col-8">
                                                <input type="text" name="IdentityNo" class="form-control form-control-user" value=<?= $res['ApplicantIdentityNo'] ?>>
                                            </div>
                                        </div>
                                        <div class="form-group mb-sm-3 row">
                                        ...
                                        <div class="form-group mb-sm-3 row">
                                            ...
                                            <div class="col-8">
                                                <input type="text" name="lastEducationName" class="form-control form-control-user" value=<?= $res['LastEducationName'] ?>>
                                            </div>
                                        </div>
